      ...
      <div className="grid gap-8 md:grid-cols-2 lg:gap-12">
        ...
        <div className="space-y-6">
          ...
          <div className="rounded-2xl bg-slate-950 p-5 text-white shadow-lg shadow-slate-900/10">
            <p className="text-xs font-bold uppercase tracking-[0.18em] text-amber-200">Prix boutique</p>
          ...
          {variants.length > 0 && (
            <div className="brand-surface space-y-4 rounded-2xl p-5">
              <div>
                ...
                <p className="mt-1 text-xs text-muted-foreground">Choisissez les options nécessaires avant la commande.</p>
              </div>
                ...
                <div key={variant.name} className="space-y-2">
                  <label className="text-sm font-bold">
                    ...
                    {!variantSelections[variant.name] && (
                      <span className="ml-2 text-xs font-medium text-muted-foreground">Choisissez une option</span>
                    )}
                  </label>
          ...
          <div className="grid grid-cols-3 gap-3 border-t border-border/60 pt-4">
            {[
              ...
              <div key={item.label} className="brand-surface flex flex-col items-center gap-1.5 rounded-2xl p-3 text-center">
